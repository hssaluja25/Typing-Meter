...
def hindi_database_file_absolute_path():
...
def fetch_text_from_id(serial_id, language):
    ...
    if language == 'english':
        ...
        database_file = hindi_database_file_absolute_path()
